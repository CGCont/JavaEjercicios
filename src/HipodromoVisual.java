...
public class HipodromoVisual extends BaseAppGUI{
    ...
    public void createComponents(){
		...
		horseImageOne 	= myComponent.getToolkit().getImage("D:/EjerciciosJava/src/cat1.gif");
		horseImageTwo 	= myComponent.getToolkit().getImage("D:/EjerciciosJava/srccat2.gif");
		winnerImage 	   = myComponent.getToolkit().getImage("D:/EjerciciosJava/src/cat3.gif");
